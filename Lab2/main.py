...
from PyQt5.QtGui import QColor, QFont, QValidator, QRegExpValidator, QTextCursor
...
class BitStaffingMethods:
    ...
    # получение флага исходя из данных
    @staticmethod
    ...
    # получение поля Source Address из имени порта
    @staticmethod
...
class Ui_PortApp(object):
   ...
   #     self.inputTextEdit.textChanged.connect()
